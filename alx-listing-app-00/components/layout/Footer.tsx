      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">{APP_NAME}</h3>
            <p className="text-gray-300 mb-4">
              Discover amazing places to stay around the world. From luxury villas to cozy cabins, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Host Support</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white text-sm">$ USD</a>
            </div>
          </div>
        </div>
      </div>
